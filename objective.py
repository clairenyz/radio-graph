...
class EntLoss(nn.Module):
    ...
    def forward(self, feat1, feat2, use_queue=False):
        ...
        sharpened_probs1 = torch.nn.functional.softmax(feat1/self.args.uda_softmax_temp, dim=-1)
        sharpened_probs2 = torch.nn.functional.softmax(feat2/self.args.uda_softmax_temp, dim=-1)
